...
window.addEventListener('load', function(){
  ...
  function displayInfos(pExists){
  if (pExists) {
    let commandInfos = JSON.parse(
      sessionStorage.getItem("Orinoco-ConfirmationInfos")
    );
    ...
    p1Elt.innerHTML =
      'Votre commande est confirmée ! Votre identifiant de commande est le suivant : </br><strong id="idCommand"></strong>';
